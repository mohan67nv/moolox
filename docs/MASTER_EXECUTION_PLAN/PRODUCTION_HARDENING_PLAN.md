...
## 2. Initial Sprint 6 certification and Sprint 7H recertification

- **Initial certification:** Sprint 6 Task 6.3 implements and certifies the P0 controls before GA.
- **Sprint 7H duration:** 30 calendar days after Sprint 7.
- **Sprint 7H role:** Re-run and expand assurance against production evidence, new Sprint 7 runtime/RAG/image/AI scope, and operational incidents. Sprint 7H does not defer initial safety until after launch.
- **Entry gate:** Sprint 7 completed and GA production evidence is available.
- **Exit gate:**
